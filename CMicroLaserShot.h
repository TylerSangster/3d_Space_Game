...
*
* @brief A projectile launched by a CMicroLaser.
*/
//##############################################################################

#ifndef CMicroLaserShot_h
#define CMicroLaserShot_h

class CMicroLaserShot: public CShot {

	public:

        //----------------------------------------------------------------------
        /**
        * @brief Creates a new CMicroLaserShot from the given location and combat
        *   variables.
        *
        * @param akdPos Where it is.
        * @param akdForward Where the CMicroLaserShot is facing.
        * @param akdUp What direction is up for the CMicroLaserShot.
        ...
        */
        //----------------------------------------------------------------------
		CMicroLaserShot(GLdouble const akdPos[3], GLdouble const akdForward[3], 
		...
		//----------------------------------------------------------------------
		/**
		* @brief Creates the display lists for all CMicroLaserShots.
		*/
		//----------------------------------------------------------------------
		...
		*/
        static const int gknAliveDisplay = 203;
        /**
		* @brief What display list to use to draw itself when it's dying.
		*/
        static const int gknDyingDisplay = 204;

};
#endif //CMicroLaserShot_h
