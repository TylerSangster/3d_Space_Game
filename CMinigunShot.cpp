...
* These are shots created by a minigun. Class CMinigunShot is responsible for 
...
//##############################################################################
    ...
    */
    //--------------------------------------------------------------------------
    CMinigunShot::CMinigunShot(GLdouble const akdPos[3], 
    ...
    //--------------------------------------------------------------------------
    /**
    * How to draw the CMinigun shot. It tightly fits a 1 length cube centered on 
    * the origin.
    */
    //--------------------------------------------------------------------------
    void CMinigunShot::Init(void) {
        ...
        GLfloat afColour[3] = {0.666,0.666,0.666};
	...
	glNewList(gknDyingDisplay, GL_COMPILE);
		CTexture cDyingTexture(13, "molten.bmp");
