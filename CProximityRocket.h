...
*
* @brief Describes a Proximity Rocket weapon.
*/
//##############################################################################

#ifndef CProximityRocket_h
#define CProximityRocket_h

class CProximityRocket: public CWeapon {
	public:
        
        //----------------------------------------------------------------------
        /**
        * @brief Creates a CProximityRocket onboard of an CEntity.
        *
        * @param pkcHost The CEntity the CProximityRocket will be aboard.
        */
        //----------------------------------------------------------------------
        CProximityRocket(CEntity* const pkcHost);
        
        //----------------------------------------------------------------------
        /**
        * @brief Creates a CProximityRocket free-floating in space.
        *
        * @param akdPos The position of the CProximityRocket.
        * @param akdForward Where the CProximityRocket is facing.
        * @param akdUp What direction is up for the CProximityRocket.
        * @param kdSpeed The speed the CProximityRocket is moving at.
        */
        //----------------------------------------------------------------------
        CProximityRocket(GLdouble const akdPos[3], GLdouble const akdForward[3],
            GLdouble const akdUp[3], const GLdouble kdSpeed);
        
        //----------------------------------------------------------------------
        /**
        * @brief Creates the display lists for the CProximityRocket.
        */
        //----------------------------------------------------------------------
		...
		*/
		static const int gknAliveDisplay = 109;
		/**
		* @brief The display list id for a dying CProximityRocket.
		*/
        static const int gknDyingDisplay = 110;
		
	protected:
        //----------------------------------------------------------------------
        /**
        * @brief Create the CProximityRocket CShots (most importantly in the 
