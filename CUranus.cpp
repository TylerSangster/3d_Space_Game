...
//##############################################################################
    ...
    */
    //--------------------------------------------------------------------------
    CUranus::CUranus(GLdouble const akdPos[3], GLdouble const akdForward[3], 
    ...
    //----------------------------------------------------------------------
    /**
    * Minimal specification constructor for a stationary CUranus.
    *
    * @param akdPos The position in cartesian co-ordinates.
    */
    //----------------------------------------------------------------------
    CUranus::CUranus(GLdouble const akdPos[3]) : CHeavenlyBody(akdPos) {
        CommonConstructor();
    }
    ...
    */
    //----------------------------------------------------------------------
    void CUranus::CommonConstructor(void) {
        //Read these from XML
        //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        m_nDamage = 10000000;
    ...
    */
    //----------------------------------------------------------------------
    void CUranus::Init(void) {
        glNewList(gknAliveDisplay, GL_COMPILE);
	
            CTexture texture(400,"uranus.bmp");
            texture.Select();		 
            GLUquadricObj *q;
            q = gluNewQuadric();
        ...
        glNewList(gknDyingDisplay, GL_COMPILE);
            ...
            CTexture texture2(401,"uranus.bmp");
            texture2.Select();		 
            GLUquadricObj *w;
            w = gluNewQuadric();
