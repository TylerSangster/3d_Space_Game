...
*
* @brief A projectile launched by a CDoomRay.
*/
//##############################################################################

#ifndef CDoomRayShot_h
#define CDoomRayShot_h

class CDoomRayShot: public CShot {

	public:

        //----------------------------------------------------------------------
        /**
        * @brief Creates a new CDoomRayShot from the given location and combat
        *   variables.
        *
        * @param akdPos Where it is.
        * @param akdForward Where the CDoomRayShot is facing.
        * @param akdUp What direction is up for the CDoomRayShot.
        ...
        */
        //----------------------------------------------------------------------
		CDoomRayShot(GLdouble const akdPos[3], GLdouble const akdForward[3], 
		...
		//----------------------------------------------------------------------
		/**
		* @brief Creates the display lists for all CDoomRayShots.
		*/
		//----------------------------------------------------------------------
		...
		*/
        static const int gknAliveDisplay = 207;
        /**
		* @brief What display list to use to draw itself when it's dying.
		*/
        static const int gknDyingDisplay = 208;

};
#endif //CDoomRayShot_h
