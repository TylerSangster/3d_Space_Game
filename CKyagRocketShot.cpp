...
* The shot from a KYAG Rocket launcher. Class CKyagRocketShot is responsible for 
* stating how it is drawn, its size, and its bounding box. Everything else is 
* handled by inheritance. Kiss Your Ass Goodbye Rocket.
*
...
//##############################################################################
    ...
    */
    //--------------------------------------------------------------------------
    CKyagRocketShot::CKyagRocketShot(GLdouble const akdPos[3], 
    ...
    //--------------------------------------------------------------------------
    /**
    * How to draw the CKyagRocket shot. It tightly fits a 1 length cube centered 
    * on the origin. Model provided by Tyler Sangster.
    */
    //--------------------------------------------------------------------------
    void CKyagRocketShot::Init(void) {
        ...
        glNewList(gknDyingDisplay, GL_COMPILE);
        	CTexture cDyingTexture(13, "purple_fire.bmp");
    ...
    */
    //--------------------------------------------------------------------------
    void CKyagRocketShot::UnInit(void) {
